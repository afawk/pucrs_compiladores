...
class ParserTokens
{
	...
	public static final int LITERAL = 258;
    ...
    private static final String tokenList[] = {"","NUM", "LITERAL", "INT", "BOOL", "TRUE", "FALSE", "VOID", "DOUBLE", "STRING", "SWITCH", "CASE", "DEFAULT", "WHILE", "DO", "FOR", "IF", "ELSE", "RETURN", "BREAK", "CONTINUE", "AND", "OR", "XOR", "NOT", "ATTRIB", "DIV", "MOD", "EQ", "NEQ", "LEQ", "GEQ", "INCREMENT", "DECREMENT"};
